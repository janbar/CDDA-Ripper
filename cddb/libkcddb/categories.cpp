  ...
  : d(new Private)
{
    ...
    d->i18n << QObject::tr("Blues") << QObject::tr("Classical") << QObject::tr("Country") <<
            QObject::tr("Data") << QObject::tr("Folk") << QObject::tr("Jazz") << QObject::tr("Miscellaneous") <<
            QObject::tr("New Age") << QObject::tr("Reggae") << QObject::tr("Rock") << QObject::tr("Soundtrack");
}
