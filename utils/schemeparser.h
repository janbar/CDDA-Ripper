...
public:
    ...
    const QString parseSimpleFilenameScheme(const QString &scheme,
                                     const int cdno,
                                     const int nooftracks,
                                     const QString &artist,
                                     const QString &title,
...
private:
    ...
    customize_placeholder_value(const QString &string, bool fat32compatible = false, bool compatible = true, bool replacespaceswithunderscores = false)
    {
        QString tmp = string;
        if (fat32compatible)
