...
#define DEFAULT_NAME ""
#define DEFAULT_ICON ":/icons/audio-x-generic.png"
...
#define LABEL_MOBILE_QUALITY " (Mobile Quality)"
#define LABEL_NORMAL_QUALITY " (Normal Quality)"
#define LABEL_EXTREME_QUALITY " (Extreme Quality)"
