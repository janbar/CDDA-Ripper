...
namespace thumbnailer
{
  ...
  class AbstractWorker : public QObject
  {
    ...
    Q_OBJECT
  public:
    AbstractWorker(QObject* parent = nullptr) : QObject(parent) { }
    ...
    virtual const QList<QByteArray>& images() const = 0;
  ...
  public:
    ...
    Job(AbstractWorker* worker, QObject* parent = nullptr);
    ~Job();
    ...
    const QList<QByteArray>& images() const;
    bool isCached() const;
  ...
  private Q_SLOTS:
    void finishedWorker() { Q_EMIT finished(); }
