...
AbstractArtistInfo* LastfmAPI::newArtistInfo(const QString& artist, int fetchCount)
{
  return new LFMArtistInfo(m_apikey, artist, fetchCount);
}

AbstractAlbumInfo* LastfmAPI::newAlbumInfo(const QString& artist, const QString& album, int fetchCount)
{
  return new LFMAlbumInfo(m_apikey, artist, album, fetchCount);
}
