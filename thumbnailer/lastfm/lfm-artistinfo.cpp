...
LFMArtistInfo::LFMArtistInfo(const QString& apiKey, const QString& artist, int fetchCount = 1)
...
AbstractAPI::Parse_Status LFMArtistInfo::parseInfo(const QByteArray& info, QList<AbstractArtistInfo::metadata_t>& metas)
{
  if (info.isEmpty())
