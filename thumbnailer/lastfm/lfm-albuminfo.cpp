...
LFMAlbumInfo::LFMAlbumInfo(const QString& apiKey, const QString& artist, const QString& album, int fetchCount = 1)
...
AbstractAPI::Parse_Status LFMAlbumInfo::parseInfo(const QByteArray& info, QList<AbstractAlbumInfo::metadata_t>& metas)
{
  if (info.isEmpty())
