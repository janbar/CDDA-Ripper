...
AbstractArtistInfo* DeezerAPI::newArtistInfo(const QString& artist, int fetchCount)
{
  return new DEEZERArtistInfo(artist, fetchCount);
}

AbstractAlbumInfo* DeezerAPI::newAlbumInfo(const QString& artist, const QString& album, int fetchCount)
{
  return new DEEZERAlbumInfo(artist, album, fetchCount);
}
