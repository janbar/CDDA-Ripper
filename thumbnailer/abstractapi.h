...
namespace thumbnailer
{
  ...
  public:
    ...
    virtual AbstractArtistInfo* newArtistInfo(const QString& artist, int fetchCount) = 0;
    virtual AbstractAlbumInfo* newAlbumInfo(const QString& artist, const QString& album, int fetchCount) = 0;
  ...
  {
  public:
    AbstractArtistInfo(const QString& artist, int fetchCount);
    ...
    virtual AbstractAPI::Parse_Status parseInfo(const QByteArray& info, QList<metadata_t>& metas) = 0;
  ...
  {
  public:
    AbstractAlbumInfo(const QString& artist, const QString& album, int fetchCount);
