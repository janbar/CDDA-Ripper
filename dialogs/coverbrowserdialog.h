...
public:
    explicit CoverBrowserDialog(thumbnailer::Thumbnailer& tbn, QWidget *parent = nullptr);
...
public Q_SLOTS:
    void fetchThumbnails(const QString &artist, const QString &title, int fetchCount = 0);
