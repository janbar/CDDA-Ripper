    ...
    : QDialog(parent)
{
    ...
    setWindowTitle(tr("Scheme Wizard"));
    ...
    connect(ui.kurllabel_aboutschemes, SIGNAL(linkActivated(const QString &)), this, SLOT(about_schemes()));
...
void SimpleSchemeWizardDialog::about_schemes()
{
    QWhatsThis::showText(
        ...
        tr("<p>Filename schemes without an absolute path will be relative to the ripped music files.</p>"
...
void SimpleSchemeWizardDialog::update_example()
{
    ...
    QString filename = schemeparser.parseSimpleFilenameScheme(ui.qlineedit_scheme->text(), 1, 12, "Meat Loaf", "Bat Out Of Hell III", "2006", "Rock", suffix, false);
