    ...
    : QDialog(parent)
{
    ...
    if (profile_row >= 0) {
        setWindowTitle(tr("Modify Profile"));
        ...
        _icon = profile_model->data(profile_model->index(profile_row, PROFILE_MODEL_COLUMN_ICON_INDEX)).toString();
        ui.label_icon->setPixmap(QPixmap(_icon).scaledToWidth(64, Qt::SmoothTransformation));
        ...
        ui.qlineedit_name->setText(tr("New Profile"));
