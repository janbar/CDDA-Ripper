    ...
    : QDialog(parent)
{
    ...
    setWindowTitle(tr("Playlist Settings"));
    ...
    ui.kcombobox_format->addItem(tr("SFV (Simple File Verification)"), "SFV");
    ui.kcombobox_format->addItem(tr("MD5 (Message-Digest algorithm 5)"), "MD5");
    {
