    ...
    : QDialog(parent)
{
    ...
    setWindowTitle(tr("Cover Settings"));
    ...
    ui.kcombobox_format->addItem(tr("JPEG (Joint Photographic Experts Group)"), "JPEG");
    ui.kcombobox_format->addItem(tr("PNG (Portable Network Graphics)"), "PNG");
    ui.kcombobox_format->addItem(tr("BMP (Windows Bitmap)"), "BMP");
    {
