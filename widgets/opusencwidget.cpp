...
{
    changed = ((horizontalSlider_bitrate->value()) != parameters->value(ENCODER_OPUSENC_BITRATE_KEY, ENCODER_OPUSENC_BITRATE).toInt() || checkBox_embedcover->isChecked() != parameters->value(ENCODER_OPUSENC_EMBED_COVER_KEY).toBool() ||
